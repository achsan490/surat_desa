...
const LAYANAN = [
  {
    ...
    icon: FileBadge,
    label: "Surat Pengantar Nikah (Model N1)",
    singkat: "N1",
    desc: "Surat pengantar rekomendasi akad nikah resmi (Model N1) untuk dikirimkan ke KUA.",
  ...
  },
  {
    ...
    singkat: "SKCK",
    desc: "Surat pengantar rekomendasi SKCK Polsek/Polres untuk melamar kerja dan CPNS.",
  ...
  },
  {
    ...
    singkat: "DOMISILI",
    desc: "Surat bukti resmi keberadaan domisili warga atau lembaga desa.",
  ...
  },
  {
    ...
    icon: Briefcase,
    label: "Surat Keterangan Kepemilikan Usaha",
    singkat: "SKU",
    desc: "Surat kepemilikan usaha warga desa untuk permodal perbankan dan izin usaha.",
